...
<header>
    ...
    <section class="article-selectione">
        <h3>montre or</h3>
        <div class="images">
            <div class="image">
                <img src="image/montre1.png" alt="montre">
            </div>
            <div class="image">
                <!-- <img src="image/montre1.png" alt="montre"> -->
            </div>
        ...
        <div class="carracteristiques">
            <div class="description">
                <small>
                    Lorem ipsum dolor sit amet consectetur
                     adipisicing elit. Obcaecati eveniet, facere vel alias
                      distinctio illo saepe consequatur aspernatur incidun
                      t enim ut ab amet nihil voluptate quam tempore 
                      laboriosam doloremque sed sint cumque quis asperiores?
                </small>
            </div>
            <div class="prix">
                <p>35 000 Fcfa</p>
            </div>
            <div class="boite-tailles">
                <small>options</small>
                <div class="tailles">
            ...
            <div class="livraison">
                <h6>livraison</h6>
                <form action="">
                    <label for="lieu">ville/commune:</label>
        ...
        <div class="actions">
            ...
            <button class="achat">voir facture</button>
        </div>
    </section>
    <section class="articles_similaire">
        <small>produits similaires</small>
        <div class="articles_sm">
            <div class="article_sm">
                <img src="image/montre2.png" alt="">
            </div>
            <div class="article_sm">
